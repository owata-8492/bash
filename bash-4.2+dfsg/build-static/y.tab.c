...
{
       0,   388,   388,   399,   408,   423,   433,   435,   439,   445,
     451,   457,   463,   469,   475,   481,   487,   493,   499,   505,
     511,   517,   523,   529,   536,   543,   550,   557,   564,   571,
     577,   583,   589,   595,   601,   607,   613,   619,   625,   631,
     637,   643,   649,   655,   661,   667,   673,   679,   685,   691,
     697,   703,   711,   713,   715,   719,   723,   734,   736,   740,
     742,   744,   760,   762,   766,   768,   770,   772,   774,   776,
     778,   780,   782,   784,   786,   790,   795,   800,   805,   810,
     815,   820,   825,   832,   837,   842,   847,   854,   859,   864,
     869,   874,   879,   886,   891,   896,   903,   906,   909,   913,
     915,   946,   953,   958,   975,   980,   997,  1004,  1006,  1008,
    1013,  1017,  1021,  1025,  1027,  1029,  1033,  1034,  1038,  1040,
    1042,  1044,  1048,  1050,  1052,  1054,  1056,  1058,  1062,  1064,
    1073,  1081,  1082,  1088,  1089,  1096,  1100,  1102,  1104,  1111,
    1113,  1115,  1119,  1120,  1123,  1125,  1127,  1131,  1132,  1141,
    1154,  1170,  1185,  1187,  1189,  1196,  1199,  1203,  1205,  1211,
...
/* Line 1806 of yacc.c  */
#line 530 "../bash/parse.y"
    {
			  source.dest = 0;
			  redir.filename = (yyvsp[(2) - (2)].word);
			  (yyval.redirect) = make_redirection (source, r_reading_until, redir, 0);
			  push_redir_stack ((yyval.redirect));
			}
    break;
